...
pintos -v -k --filesys-size=2 -p ../examples/lab2test_new -a lab2 -- -f -q run lab2
...
const char *crlf_warning
	 = ("\033[1;31;40mWARNING\033[1;0m: "
...
static void verify(int test)
{
	...
	const char *result[3]
		 = {"\033[1;31;40m WRONG RESULT \033[1;0m \n",
